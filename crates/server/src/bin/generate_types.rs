...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::project_status_automation::ProjectStatusAutomation::decl(),
        db::models::project_status_automation::UpdateProjectStatusAutomation::decl(),
        db::models::project_status_automation::AutomationStartMode::decl(),
        db::models::project_status_automation::AutomationSessionMode::decl(),
        db::models::project_status_automation::AutomationCompletionMode::decl(),
        db::models::project_status_automation::AutomationStatusReference::decl(),
        db::models::project_status_automation::AutomationStatusValidation::decl(),
        db::models::project_status_automation::ProjectStatusAutomationProblem::decl(),
        db::models::project_status_automation::ProjectStatusAutomationValidation::decl(),
        db::models::project_status_automation::ProjectStatusAutomationResponse::decl(),
        db::models::project_status_automation::ListProjectStatusAutomationsResponse::decl(),
        db::models::project_status_stage_run::IssueStatusObservation::decl(),
        db::models::project_status_stage_run::StatusEntryKind::decl(),
        db::models::project_status_stage_run::StageRunTrigger::decl(),
        db::models::project_status_stage_run::StageRunStatus::decl(),
        db::models::project_status_stage_run::ProjectStatusEntry::decl(),
        db::models::project_status_stage_run::ProjectStatusStageRun::decl(),
        db::models::project_status_stage_run::ProjectStatusStageRunSummary::decl(),
        db::models::project_status_stage_run::ProjectStatusStageRunResponse::decl(),
        db::models::project_status_stage_run::IssueAutomationState::decl(),
        db::models::project_status_stage_run::ProjectAutomationOverview::decl(),
        db::models::project_status_stage_result::ProjectStatusStageAttempt::decl(),
        db::models::project_status_stage_result::StageResultOutcome::decl(),
        db::models::project_status_stage_result::ProjectStatusStageResult::decl(),
        db::models::project_status_stage_result::ProjectStatusStageResultRepository::decl(),
        db::models::project_status_stage_result::ProjectStatusStageResultResponse::decl(),
        db::models::project_status_stage_result::ProjectStatusStageAttemptResponse::decl(),
        db::models::project_status_workflow::WorkflowRunStatus::decl(),
        db::models::project_status_workflow::ProjectStatusWorkflowRun::decl(),
        db::models::project_status_workflow::StageContinuationStatus::decl(),
        db::models::project_status_workflow::ProjectStatusStageContinuation::decl(),
        ...
        server::routes::project_status_automations::ProjectStatusAutomationError::decl(),
        server::routes::project_status_stage_runs::ObserveIssueStatusesRequest::decl(),
        server::routes::project_status_stage_runs::ObserveIssueStatusesResponse::decl(),
        server::routes::project_status_stage_runs::StartProjectStatusStageRequest::decl(),
        server::routes::project_status_stage_runs::ResumeProjectStatusAutomationRequest::decl(),
