...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::project_workflow_config::ProjectWorkflowConfig::decl(),
        db::models::project_workflow_config::UpdateProjectWorkflowConfig::decl(),
        db::models::project_workflow_config::ProjectWorkflowConfigResponse::decl(),
        db::models::project_workflow_config::WorkflowConfigProblem::decl(),
        db::models::project_workflow_config::WorkflowRole::decl(),
        ...
        server::routes::project_workflow_configs::WorkflowConfigError::decl(),
